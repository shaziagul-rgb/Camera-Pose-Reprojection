...
ProjectPoints is a computer vision toolkit for evaluating 2D/3D point reprojection accuracy.

The repository contains two closely related components:

1. **2D Point Annotation**: an interactive Python tool for selecting image points.
...
![Generated points](docs/images/output.png)
